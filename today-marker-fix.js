(() => {
  ...
  function placeMarker(){
    ...
    // Eski tasarımdan kalabilecek blok-içi göstergeleri temizle.
    ...
    // Saat, son başlamış bloğun hemen altında küçük bir ray işareti olarak görünür.
    if(latest){
  ...
  style.textContent=`
    .hm-agenda-now.hm-now-rail-marker{
      position:relative;
      z-index:6;
      display:grid;
    ...
    .hm-now-time-flag{
      ...
      color:#fff;
      text-align:center;
      box-shadow:0 4px 10px rgba(47,126,230,.24);
    }
    .hm-now-time-flag::after{
      content:"";
      position:absolute;
      right:-5px;
      top:50%;
    ...
    .hm-now-rail-pin{
      ...
      box-shadow:0 0 0 3px rgba(47,126,230,.20),0 3px 8px rgba(47,126,230,.20);
    }
    .hm-now-rail-pin::after{
      content:"";
      position:absolute;
      inset:-6px;
      border-radius:50%;
      border:1px solid rgba(47,126,230,.18);
    }
    .hm-now-short-tick{
      width:18px;
      height:3px;
    ...
    .hm-agenda-now.hm-now-rail-marker .hm-agenda-now-time,
    .hm-agenda-now.hm-now-rail-marker .hm-agenda-now-dot,
    .hm-agenda-now.hm-now-rail-marker .hm-agenda-now-line,
    .hm-agenda-now.hm-now-rail-marker .hm-now-chip,
    .hm-agenda-now.hm-now-rail-marker .hm-now-spacer,
    .hm-agenda-now.hm-now-rail-marker .hm-now-rail-dot{display:none!important}
    @media(max-width:720px){
      .hm-agenda-now.hm-now-rail-marker{grid-template-columns:62px 16px minmax(0,1fr);min-height:28px}
      .hm-now-time-flag{min-width:46px;margin-right:7px;padding:5px 7px}
      .hm-now-time-flag strong{font-size:10px}
      .hm-now-rail-pin{width:11px;height:11px}
      .hm-now-short-tick{width:14px;margin-left:3px}
    }
  `;
