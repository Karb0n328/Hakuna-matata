const CACHE='hakuna-matata-v22-ios-png-icon';
const ASSETS=['./','./index.html','./styles.css','./mata.css','./ui-fixes.css','./today-agenda.css','./main.js','./migration.js','./app.js','./week-settings.js','./ui-fixes.js','./today-agenda.js','./today-marker-fix.js','./mata-fallback.js','./mata-loader.js','./mata-observer-guard.js','./mata-core-v2.js','./mata-nlu-v2.js','./mata-ui-v2.js','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192-v3.png','./icons/apple-touch-icon-v3.png','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png','./assets/mata.svg'];
